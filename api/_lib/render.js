...
function articleHeader() {
  return `<header class="top"><a class="brand" href="../"><img src="../logo.png" alt="Logo Ativa Digital ON"><span><strong>Ativa Digital <b>ON</b></strong><small>TECNOLOGIA E ESTRATÉGIA PARA EMPRESAS</small></span></a><nav class="nav" aria-label="Navegação do artigo"><a href="./">Blog</a><a href="../">Site principal</a></nav><a class="btn primary" href="https://wa.me/${WHATSAPP}?text=Olá!%20Quero%20melhorar%20a%20presença%20digital%20da%20minha%20empresa." target="_blank" rel="noopener noreferrer">Falar com a Ativa →</a></header>`;
}

function articleFooter() {
  return `<footer class="footer"><div class="wrap footer-main"><div><a class="brand" href="../"><img src="../logo.png" alt=""><span><strong>Ativa Digital <b>ON</b></strong><small>PRESENÇA DIGITAL PRONTA PARA VENDER</small></span></a><p>© 2026 Ativa Digital ON.</p></div><div class="social"><a href="./">Blog</a><a href="../">Site principal</a><a href="https://instagram.com/ativadigitalon" target="_blank" rel="noopener noreferrer">Instagram ↗</a></div></div></footer><a class="wa" href="https://wa.me/${WHATSAPP}?text=Olá!%20Encontrei%20a%20Ativa%20pelo%20blog." target="_blank" rel="noopener noreferrer">WhatsApp</a>`;
}
...
function renderArticle(post, posts) {
  ...
  const schema = {
    ...
    publisher: { '@type': 'Organization', name: 'Ativa Digital ON', logo: { '@type': 'ImageObject', url: `${SITE_URL}/logo.png` } },
...
<head>
  ...
  <link rel="icon" href="../logo.png" type="image/png"><link rel="canonical" href="${articleUrl}"><link rel="stylesheet" href="./styles.css"><link rel="stylesheet" href="./images.css">
