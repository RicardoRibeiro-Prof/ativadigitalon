document.addEventListener('DOMContentLoaded',()=>{
  ...
  if(footer){
    footer.innerHTML=`
      <div class="container footer-main">
        ...
        <div class="footer-column">
          <h2>Contato</h2>
          <a href="https://wa.me/5589981311034?text=Olá!%20Quero%20uma%20página%20profissional%20para%20meu%20negócio." target="_blank" rel="noopener">(89) 98131-1034</a>
          <a href="https://instagram.com/ativadigitalon" target="_blank" rel="noopener">@ativadigitalon</a>
  ...
  style.textContent=`
    ...
    .footer-column a:hover{color:#ff7300}
