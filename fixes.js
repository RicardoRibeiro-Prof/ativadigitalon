      ...
      <div class="container footer-main">
        <div class="footer-brand-block">
          <a class="footer-brand-link" href="#inicio" aria-label="Voltar ao início">
            <img src="./logo.png" alt="Logo da AtivaDigitalOn">
